...
```
![Figure of Circuit](https://github.com/javierramirezzayas/logically/blob/master/logicallyCKT.JPG =300x300)
...
a or ( a and b )
```
![Figure of Venn Diagram](https://github.com/javierramirezzayas/logically/blob/master/logicallyVENN.JPG =300x300)
