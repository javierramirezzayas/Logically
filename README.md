...
```
![Figure of Circuit] (https://github.com/javierramirezzayas/logically/blob/master/logicallyCKT.JPG)
...
a or ( a and b )
```
![Figure of Venn Diagram] (https://github.com/javierramirezzayas/logically/blob/master/logicallyVENN.JPG)
